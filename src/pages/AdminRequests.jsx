...
export default function AdminRequests() {
  ...
  const fetchRequests = async () => {
    try {
      const response = await axios.get("/admin/tour-requests");
  ...
  const handleAcceptRequest = async () => {
    try {
      await axios.put(`/admin/tour-requests/${selectedRequest._id}/accept`, {
  ...
  const handleDeclineRequest = async () => {
    try {
      await axios.put(`/admin/tour-requests/${selectedRequest._id}/decline`, {
        adminResponse: response,
      });
  ...
  const handleDelete = async (requestId) => {
    if (window.confirm("Are you sure you want to delete this tour request?")) {
      try {
        await axios.delete(`/admin/tour-requests/${requestId}`);
  ...
  return (
    ...
    >
      ...
      >
        <DialogTitle>Admin Response to Tour Request</DialogTitle>
        <DialogContent
          dividers
          sx={{
          ...
          {selectedRequest && (
            <Box>
              ...
              <TextField
                ...
                fullWidth
                placeholder="Provide admin response, approval details, or any special instructions..."
              />
            </Box>
          )}
        </DialogContent>
